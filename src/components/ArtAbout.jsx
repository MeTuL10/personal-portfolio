...
const PILLS = ['Animation','Environment Art','Perspective & Depth','Character Design','Lighting & Shading'];
  ...
  return (
    ...
    >
      ...
      <div className={styles.intro}>
        <BlurText text="Hi, I'm also" as="p" animateBy="words" delay={60} duration={0.55} className={styles.greeting} />

        {/* ShinyText for name — preserves art-profile gradient */}
        <ShinyText text="Metul Prabhu" as="h1" speed={3.5} colorA="#ffffff" colorB="var(--art-bright)" className={styles.name} />
        ...
        <FadeContent blur delay={0.3} duration={0.65}>
          <p className={styles.bio}>
            I'm a self-taught digital artist passionate about fan art, character illustration
            and storytelling through visuals. I'm currently learning animation, environment
            art and perspective techniques. Most of my work lives on DeviantArt, where I share
            my progress and finished pieces.
          </p>
        </FadeContent>
        ...
        <FadeContent delay={0.42} duration={0.6}>
          <div className={styles.socialRow}>
            <Magnet magnetStrength={0.42}>
              <a href="https://www.deviantart.com/metalex10" className={styles.daBtn} target="_blank" rel="noreferrer">
              ...
              >
                {PILLS.map((item) => (
                  <motion.span key={item} className={styles.pill}
                    variants={{ hidden:{opacity:0,y:14,scale:0.9}, visible:{opacity:1,y:0,scale:1,transition:{duration:0.5,ease:[0.16,1,0.3,1]}} }}
